...
void draw_game_screen(int game_x_length, int game_y_length, int score_x_length, int score_y_length, const ELEMENT area[game_x_length][game_y_length], const char score[], int value, bool id);
